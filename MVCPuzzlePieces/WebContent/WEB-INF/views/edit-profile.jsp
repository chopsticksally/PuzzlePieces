	...
	<div class="container">
		...
		<div class="wrapper">
			<form action="updateUser.do" method="post" class="form-signin">
				...
				<label for="userName">New Username:</label> <input type="text"
					class="form-control" name="userName"
					value="${userLoggedIn.userName}" placeholder="New Username"
					required="" autofocus="" min="1" max="100" /> <label
					for="userName">New Password:</label> <input type="password"
					class="form-control" name="password" placeholder="New Password"
					value="${userLoggedIn.password }" required="" /> <label
					for="userName">Confirm New Password:</label> <input type="password"
		...
		<div class="wrapper">
			<form action="updateUserInformation.do" method="post"
				...
				<label for="userName">First Name:</label> <input type="text"
					...
					value="${userLoggedIn.userInformation.firstName }"
		...
		<div class="wrapper">
			<form action="updateAddress.do" method="post" class="form-signin">
				...
				<label for="street">Street:</label> <input type="text"
					...
					value="${userLoggedIn.userInformation.address.street}"
				...
				<label for="street2">Apt/Suite #:</label> <input type="text"
					...
					value="${userLoggedIn.userInformation.address.street2 }" />
				...
				<label for="postalCode">Postal Code:</label> <input type="text"
					...
					value="${userLoggedIn.userInformation.address.postalCode }"
					required="" />
